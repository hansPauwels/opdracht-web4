...
public class Person {
	...
	public void setCustomStatus (String newCStatus) {
	    /*if(newCStatus == null || newCStatus.trim().isEmpty()) {
	        throw new IllegalArgumentException("Custom status cannot be empty");
        } */
